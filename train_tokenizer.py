...
def read_texts_from_corpus(corpus_dir: str) -> Generator[str, None, None]:
    """递归读取语料目录中所有JSON文件并提取文本数据"""
...
def create_tokenizer_config(save_dir: str) -> None:
    ...
    with open(
        os.path.join(save_dir, "special_tokens_map.json"), "w", encoding="utf-8"
    ) as f:
...
def train_tokenizer(data_path: str, save_dir: str, vocab_size: int = 8192) -> None:
    ...
    texts = read_texts_from_corpus(data_path)
...
def main():
    # 配置路径
    data_path = r"./dataset/mobvoi_seq_monkey_classical_chs_open_corpus"
    save_dir = r"./tokenizer_k"
